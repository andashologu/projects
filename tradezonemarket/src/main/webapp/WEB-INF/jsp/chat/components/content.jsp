...
<div style="position: relative; flex-grow: 0; background-color: #cacaca05" class="field-wrapper-2">
    ...
    <div style="padding: 0 10px;" class="row">
        <div class="field-wrapper-2">
            <textarea id="privateText" class="text-field small-text dark" type="text" placeholder="type a message..."></textarea>
            <div class="horozontalline"></div>
        </div>
        <div>
            <button type="button" onclick="sendPrivateMessage()" style="max-height: 35px; border-radius: 50%; padding: 5px;" class="button small-text">   
