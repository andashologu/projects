                ...
                <div class="auth_form_wrapper large">
                    ...
                    <form:form class="form-block" method="POST" action="/signup" modelAttribute="user">
                        <div class="field-wrapper-2 small-margin">
                            ...
                            <div class="field-wrapper">
                                <div class="field-wrapper-2">
                                    <input class="text-field-2 small-text" type="text" placeholder="First name" value="${user.firstname}" name="firstname"/>
                                    <form:errors path="firstname" class="error small-text"/>
                                </div>
                                <div class="field-wrapper-2">
                                    <input class="text-field-2 small-text dark" type="text" placeholder="Last name" value="${user.lastname}" name="lastname"/>
                        ...
                        <div class="field-wrapper-2">
                            ...
                            <div class="field-wrapper">
                                <div class="field-wrapper-2">
                                    <input class="text-field-2 small-text dark" type="text" placeholder="Street" value="${user.address.street}" name="address.street"/>
                                    <form:errors path="address.street" class="error small-text"/>
                                </div>
                                <div class="field-wrapper-2">
                                    <input class="text-field-2 small-text" type="text" placeholder="City" value="${user.address.city}" name="address.city"/>
                                    <form:errors path="address.city" class="error small-text"/>
                                </div>
                            </div>
                            <div class="field-wrapper">
                                <div class="field-wrapper-2">
                                    <input class="text-field-2 small-text" type="text" placeholder="Country" value="${user.address.country}" name="address.country"/>
                                    <form:errors path="address.country" class="error small-text"/>
                                </div>
                                <div class="field-wrapper-2">
                                    <input class="text-field-2 small-text dark" type="number" placeholder="Zip code" value="${user.address.zip}" name="address.zip"/>
                        ...
                        <div style="width: max-content;" class="field-wrapper-2 medium-margin">
                            ...
                            <input class="text-field-2 small-text" type="email" placeholder="e.g email@gmail.com" value="${user.email}" name="email"/>
                        ...
                        <div style="width: max-content;" class="field-wrapper-2 medium-margin">
                            ...
                            <input class="text-field-2 small-text" type="text" placeholder="Company name" value="${user.company}" name="company"/>
                        ...
                        <div class="field-wrapper small-margin">
                            ...
                            <div class="field-wrapper-2">
                                <input class="text-field-2 small-text" type="text" placeholder="e.g Smith" value="${user.username}" name="username"/>
                        ...
                        <div class="field-wrapper medium-margin">
                            ...
                            <div class="field-wrapper-2">
                                <input class="text-field-2 small-text" type="password" placeholder="********" value="${user.password}" name="password"/>
                                <form:errors path="password" class="error small-text"/>
                            </div>
                        </div>
                        <input style="min-width: 280px; margin: 0 auto; border-radius: 8px; padding: 8px 5px; justify-content: center;" class="button small-text" type="submit" value="Submit"/>
