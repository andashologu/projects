        ...
        <div id="modal" class="page-padding full_centered">
            <div class="container">
                <div style="box-shadow: 0 0 6px #efefef inset; background: linear-gradient(90deg, white 50%, #efefef 50%);" class="auth_form_wrapper drop-shadow lifted">
                    ...
                    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.96 25.06">
                        ...
                        <rect fill="white" class="cls-1" x="18" y="21.06" width="4" height="4"/>
                        <path fill="white" class="cls-1" d="m18,20.06h4s0-6.06,0-6.06c0,0,.2-1.63,1.41-1.75l1.71-.05,1.41.04c1.27.03,1.41,1.76,1.41,1.76v11.06h4.02v-11.17s-.02-3.5-.28-4.38c0,0-.05-2.74-3.74-2.73-2.33-.01-2.97,2.71-2.97,2.71,0,0-.37-2.72-2.97-2.71,0,0-2.5-.03-4,0v13.28Z"/>
                    </svg>
                    <form:form style="border-radius: 5px; box-shadow: -1px 0px 1px #efefef inset;" id="login_form" class="form-block"  action="/login" method="POST">
                        ...
                        <div style="gap: 10px;" class="field-wrapper-2 medium-margin">
                            <div style="column-gap: 0;" class="row">
                                ...
                                <a style="color: gray; flex-grow: 1; justify-content: center;"  id="signup_btn" href="/signup" class="button smaller-text dark">
                                    Sign up
                            ...
                            <a style="color: gray; max-width: 50%;" id="pwd_btn" href="" class="button small-text dark small-margin">Forgot password ?</a>
                        </div>
