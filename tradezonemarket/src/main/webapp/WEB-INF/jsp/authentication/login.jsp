        ...
        <div id="modal" class="page-padding full_centered">
            <div class="container">
                <div style="box-shadow: 0 0 6px #efefef inset;" class="auth_form_wrapper drop-shadow lifted">
                    ...
                    <div></div>
                    <svg style="height: 50%; width: 100%; background: linear-gradient(90deg, whitesmoke 50%, white 50%);" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.96 25.06">
                        <rect fill="white" class="cls-1" y="1.51" width="8" height="4"/>
                        <rect fill="white" class="cls-1" x="4" y="5.51" width="4" height="19.55"/>
                        <rect fill="white" class="cls-1" x="9" y="1.51" width="4" height="4"/>
                    ...
                    <form:form style="border-radius: 5px; box-shadow: -1px 0px 1px #efefef inset; padding: 20px 70px;" id="login_form" class="form-block"  action="/login" method="POST">
                        ...
                        <div style="gap: 10px;" class="field-wrapper-2 medium-margin">
                            <div style="column-gap: 0;" class="row">
                                ...
                                <a style="box-shadow: 0px 0px 2px 0px #cacaca; color: gray; flex-grow: 1; justify-content: center;"  id="signup_btn" href="/signup" class="button smaller-text dark">
                                    Sign up
                            ...
                            <a style="color: gray;" id="pwd_btn" href="" class="button small-text dark small-margin">Forgot password ?</a>
                        </div>
