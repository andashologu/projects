        ...
        <div id="modal" class="page-padding full_centered">
            <div class="container">
                <div style="box-shadow: 0 0 6px #efefef inset;" class="auth_form_wrapper drop-shadow lifted">
                    ...
                    <form:form style="border-radius: 5px; padding: 20px 70px;" id="login_form" class="form-block"  action="/login" method="POST">
                        ...
                        <div style="gap: 10px;" class="field-wrapper-2 medium-margin">
                            <div style="column-gap: 0;" class="row">
                                ...
                                <a style="box-shadow: 0px 0px 2px 0px #cacaca; flex-grow: 1; justify-content: center;"  id="signup_btn" href="/signup" class="button smaller-text dark">
                                    Sign up
